          ...
          <div class="col-md-10">
            ...
            <form action="" method="">
              ...
              <div class="form-group row form2">
                ...
                <div class="col-md-10">
                  <input type="password" id="inputPassword5" class="form-control" aria-describedby="passwordHelpBlock" placeholder="..." required>
                </div>
              </div>
              ...
              <div class="row ROW2">
              	...
              	<div class="col-md-6">
              		<div class="row">
	              		<a class="btn btn-primary BUT2" href="profile.html" role="button">Edit Profile</a>
	              	</div>
              	</div>
              	<div class="col-md-4">
              		<div class="row">
	              		<a class="btn btn-primary BUT2" href="home.html" role="button">Back</a>
	              	</div>
              	</div>
              	<div class="col-md-1"></div>
              </div>
